...
import PageObjectImplementation.MultiPTPsModule.MultiVaryingInstallmentPtpActions;
...
public class CustomerLevelMultiVaryingInstallmentPtpTest extends TestInitialize {


    LoginPageActions login = new LoginPageActions();
    LogoutPageActions logout = new LogoutPageActions();
    MultiVaryingInstallmentPtpActions multiVarying = new  MultiVaryingInstallmentPtpActions();
    ...
    public void TC002_MultiVaryingInstallmentPTP() {
        try{
            System.out.println("USER SEARCH ACCOUNT: STARTED");
            multiVarying.multiVaryingInstallmentPtp();
        }catch (Exception e){
