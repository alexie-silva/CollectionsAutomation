...
public class CustomerLevelSingleInstallmentPtpPage extends Action {
    ...
    public String rdbtnAccount = "//input[@value='5|13|0|0']";
    public String frmSearchResults = "//frame[@name='searchResultFrame']";
    public String btnLHS = "//img[@style='cursor: pointer']";
    ...
    public String btnAdvanceView = "//a[@title='Customer Level']";
    public String btnAddnewItem = "(//a[@class='Link_menu'])[2]";
    public String btnRemoveItem = "(//a[@title='Remove Item'])[4]";
    public String dpdValue = "(//a[@class='rfExp'])[1]";
    public String dpdValueIsNotNull = "(//span[@class='rmText'])[20]";
    public String btnApply = "//input[@class='rfButton']";
    public String chkbxValue1 = "//input[@id='ctl00_contentPlaceHolder_accountSearch_grvCustomerAccount_ctl00_ctl34_chkSelectedItem']";
    public String chkbxValue2 = "//input[@id='ctl00_contentPlaceHolder_accountSearch_grvCustomerAccount_ctl00_ctl30_chkSelectedItem']";
