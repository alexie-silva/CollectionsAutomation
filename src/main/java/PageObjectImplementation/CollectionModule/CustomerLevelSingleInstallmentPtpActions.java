...
import PageObject.CollectionPage.CustomerLevelSingleInstallmentPtpPage;
...
public class CustomerLevelSingleInstallmentPtpActions extends CustomerLevelSingleInstallmentPtpPage {
    ...
    public void singleInstallmentPTP() throws InterruptedException {
        ...
        String date = readExcel("TestData", "Date", 1, 2);
        ...
        switchFrame("(//iframe[@id='RadWindowContentFramewinRMPMonitoring'])[1]");
